...
ADDON=xbmcaddon.Addon(id='plugin.video.kbuildrpi')
...
def CATEGORIES():
    link = OPEN_URL('https://raw.githubusercontent.com/RuiNascimento/krepo/master/builds_rpi2_openelec.txt').replace('\n','').replace('\r','')
