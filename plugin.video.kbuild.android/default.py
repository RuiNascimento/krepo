...
ADDON=xbmcaddon.Addon(id='plugin.video.kbuildandroid')
...
def CATEGORIES():
    link = OPEN_URL('https://raw.githubusercontent.com/RuiNascimento/krepo/master/builds_android.txt').replace('\n','').replace('\r','')
